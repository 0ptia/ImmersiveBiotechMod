 ...
 * Date: 06/01/2015
 *
 * GuiInventoryAdvanced is a gui similar to that of a Microcentrifuge. It has a progress bar and a burn time indicator.
 * Both indicators have mouse over text
 */
@SideOnly(Side.CLIENT)
public class GuiInventoryMicrocentrifuge extends GuiContainer {

	// This is the resource location for the background image
	private static final ResourceLocation texture = new ResourceLocation("minecraftbyexample", "textures/gui/mbe31_inventory_Microcentrifuge_bg.png");
	private TileInventoryMicrocentrifuge tileEntity;

	public GuiInventoryMicrocentrifuge(InventoryPlayer invPlayer, TileInventoryMicrocentrifuge tileInventoryMicrocentrifuge) {
		super(new ContainerInventoryMicrocentrifuge(invPlayer, tileInventoryMicrocentrifuge));

		// Set the width and height of the gui
		xSize = 176;
		ySize = 207;

		this.tileEntity = tileInventoryMicrocentrifuge;
	}
