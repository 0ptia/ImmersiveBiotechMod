 ...
 */
public class TileInventoryMicrocentrifuge extends TileEntity implements IInventory, ITickable {
	...
	public TileInventoryMicrocentrifuge()
	{
	...
	public static ItemStack getSmeltingResultForItem(ItemStack stack) { return MicrocentrifugeRecipes.instance().getSmeltingResult(stack); }
 ...
 */
  ...
  //------------------------
	...
	public String getName() {
		return "container.inventory_microcentrifuge.name";
	}
