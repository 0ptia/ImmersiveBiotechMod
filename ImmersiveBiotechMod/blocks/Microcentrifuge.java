 ...
 * //Note that in 1.10.*, extending BlockContainer can cause rendering problems if you don't extend getRenderType()
 ...
 //  need to implement.
 */
public class Microcentrifuge extends BlockContainer
{
	public Microcentrifuge()
	{
		super(Material.ROCK);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileInventoryMicrocentrifuge();
	}
...
//		}
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos)
	{
		...
		if (tileEntity instanceof TileInventoryMicrocentrifuge) {
			...
			int burningSlots = tileInventoryMicrocentrifuge.numberOfBurningFuelSlots();
